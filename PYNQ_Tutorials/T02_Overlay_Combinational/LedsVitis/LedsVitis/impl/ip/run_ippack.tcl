...
set IPName      "ledsPrj"
set Version     "1.0"
set DisplayName "LedsPrj"
set Revision    "3"
set Description "Leds Control"
set Device      "zynq"
set AutoFamily  ""
...
set xo_kernel_name "ledsPrj"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/GitHub/GICM_Xilinx_Tutorial/PYNQ_Tutorials/T02_Overlay_Combinational/LedsVitis/LedsVitis"
set debug_dir "C:/GitHub/GICM_Xilinx_Tutorial/PYNQ_Tutorials/T02_Overlay_Combinational/LedsVitis/LedsVitis/.debug"
set xo_hls_files_dir ""
set hdl_module_list {ledsPrj_control_s_axi
ledsPrj
}
set kernel_xo ""
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 led_reg W 0x0 "Data signal of led_reg" {{0 32 led_reg W 0 "Bit 31 to 0 of led_reg"}}} {0x18 sw_reg R 0x0 "Data signal of sw_reg" {{0 32 sw_reg R 0 "Bit 31 to 0 of sw_reg"}}} {0x1c sw_reg_ctrl R 0x0 "Control signal of sw_reg" {{0 1 sw_reg_ap_vld R 0 "Control signal sw_reg_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
