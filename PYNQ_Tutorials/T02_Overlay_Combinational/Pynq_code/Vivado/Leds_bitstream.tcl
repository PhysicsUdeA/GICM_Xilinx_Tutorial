...
################################################################
# This is a generated script based on design: design_Leds
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set led_0 [ create_bd_port -dir O -type data led_0 ]
  set sw_0 [ create_bd_port -dir I -from 0 -to 0 -type data sw_0 ]

  # Create instance: ledsPrj_0, and set properties
  set ledsPrj_0 [ create_bd_cell -type ip -vlnv Fabian:hls:ledsPrj:1.0 ledsPrj_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ledsPrj_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net ledsPrj_0_led [get_bd_ports led_0] [get_bd_pins ledsPrj_0/led]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ledsPrj_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ledsPrj_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sw_0_1 [get_bd_ports sw_0] [get_bd_pins ledsPrj_0/sw]

  # Create address segments
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ledsPrj_0/s_axi_control/Reg] -force
