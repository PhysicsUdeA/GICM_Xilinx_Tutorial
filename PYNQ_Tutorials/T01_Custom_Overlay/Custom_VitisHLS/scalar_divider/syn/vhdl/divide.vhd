...
architecture behav of divide is 
    ...
    signal grp_fu_57_ap_start : STD_LOGIC;
    signal grp_fu_57_ap_done : STD_LOGIC;
    ...
    component divide_sdiv_32ns_32ns_32_36_seq_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component divide_control_s_axi IS
    generic (
...
begin
    control_s_axi_U : component divide_control_s_axi
    generic map (
    ...
    sdiv_32ns_32ns_32_36_seq_1_U1 : component divide_sdiv_32ns_32ns_32_36_seq_1
    generic map (
        ID => 1,
        NUM_STAGE => 36,
        din0_WIDTH => 32,
    ...
    grp_fu_57_ap_start_assign_proc : process(ap_CS_fsm_state1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state1)) then 
            grp_fu_57_ap_start <= ap_const_logic_1;
        else 
            grp_fu_57_ap_start <= ap_const_logic_0;
        end if; 
    end process;
