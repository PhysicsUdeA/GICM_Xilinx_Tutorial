...
## Buttons
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports {sw_in_0[0]}]
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS33} [get_ports {sw_in_0[1]}]
set_property -dict {PACKAGE_PIN L20 IOSTANDARD LVCMOS33} [get_ports {sw_in_0[2]}]
set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS33} [get_ports {sw_in_0[3]}]

## LEDs
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[0]}]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[1]}]
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[2]}]
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports {leds_out_0[3]}]
...
## Arduino analog
set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVCMOS33} [get_ports vauxn1_0]
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS33} [get_ports vauxp1_0]
set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports vauxn9_0]
set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports vauxp9_0]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports vauxn6_0]
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports vauxp6_0]
