...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../IPCore_Prj.gen/sources_1/bd/design_IP/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../IPCore_Prj.gen/sources_1/bd/design_IP/ipshared/ee60/hdl" \
       +incdir+"../../../../IPCore_Prj.gen/sources_1/bd/design_IP/ipshared/ec67/hdl" \
       +incdir+"../../../../IPCore_Prj.gen/sources_1/bd/design_IP/ipshared/ee60/hdl" \
