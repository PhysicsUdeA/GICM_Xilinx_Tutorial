...
entity design_Interrupt_wrapper is
  port (
...
end design_Interrupt_wrapper;

architecture STRUCTURE of design_Interrupt_wrapper is
  component design_Interrupt is
  port (
    btn_0 : in STD_LOGIC;
    sw_0 : in STD_LOGIC;
    DDR_cas_n : inout STD_LOGIC;
  ...
  end component design_Interrupt;
  component IOBUF is
  port (
    I : in STD_LOGIC;
    O : out STD_LOGIC;
...
begin
design_Interrupt_i: component design_Interrupt
     port map (
