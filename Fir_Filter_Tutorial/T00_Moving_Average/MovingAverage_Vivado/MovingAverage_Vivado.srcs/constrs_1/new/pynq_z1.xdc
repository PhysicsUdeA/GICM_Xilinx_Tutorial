...
## Arduino analog
set_property PACKAGE_PIN E19 [get_ports { JA[0] }];
set_property IOSTANDARD LVCMOS33 [get_ports { JA[0] }]; # it is neccesary like this because incompatibility in banck voltage definition
set_property PACKAGE_PIN E18 [get_ports { JA[1] }];
...
#set_property -dict {PACKAGE_PIN E19 IOSTANDARD LVCMOS33} [get_ports { JA[0] }];
#set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVCMOS33} [get_ports { JA[1] }];
