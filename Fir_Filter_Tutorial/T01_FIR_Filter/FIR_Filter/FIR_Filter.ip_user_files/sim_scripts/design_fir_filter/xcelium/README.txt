...
#
# Generated by export_simulation on Tue Jan 03 18:40:26 -0500 2023
#
################################################################################
...
'-reset_run' switch to the './design_fir_filter.sh' script.

./design_fir_filter.sh -reset_run
...
./design_fir_filter.sh -noclean_files

For more information on the script, please type './design_fir_filter.sh -help'.
