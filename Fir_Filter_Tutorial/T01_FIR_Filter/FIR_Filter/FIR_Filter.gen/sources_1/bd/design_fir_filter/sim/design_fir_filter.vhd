...
--Date        : Tue Jan  3 18:40:19 2023
--Host        : fabiancastano running 64-bit major release  (build 9200)
--Command     : generate_target design_fir_filter.bd
--Design      : design_fir_filter
...
entity design_fir_filter is
  ...
  attribute CORE_GENERATION_INFO of design_fir_filter : entity is "design_fir_filter,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_fir_filter,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of design_fir_filter : entity is "design_fir_filter.hwdef";
end design_fir_filter;

architecture STRUCTURE of design_fir_filter is
  component design_fir_filter_processing_system7_0_0 is
  port (
  ...
  end component design_fir_filter_processing_system7_0_0;
  component design_fir_filter_sine_0_0 is
  port (
    clk : in STD_LOGIC;
    sinus : out STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  end component design_fir_filter_sine_0_0;
  component design_fir_filter_fir_compiler_0_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component design_fir_filter_fir_compiler_0_0;
  ...
  signal sine_0_sinus : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  signal NLW_fir_compiler_0_m_axis_data_tdata_UNCONNECTED : STD_LOGIC_VECTOR ( 39 downto 0 );
...
begin
fir_compiler_0: component design_fir_filter_fir_compiler_0_0
     port map (
      aclk => processing_system7_0_FCLK_CLK0,
      m_axis_data_tdata(39 downto 0) => NLW_fir_compiler_0_m_axis_data_tdata_UNCONNECTED(39 downto 0),
      m_axis_data_tvalid => NLW_fir_compiler_0_m_axis_data_tvalid_UNCONNECTED,
      s_axis_data_tdata(15 downto 0) => sine_0_sinus(15 downto 0),
      s_axis_data_tready => NLW_fir_compiler_0_s_axis_data_tready_UNCONNECTED,
      s_axis_data_tvalid => '0'
    );
processing_system7_0: component design_fir_filter_processing_system7_0_0
     port map (
...
sine_0: component design_fir_filter_sine_0_0
     port map (
      clk => processing_system7_0_FCLK_CLK1,
      sinus(15 downto 0) => sine_0_sinus(15 downto 0)
    );
end STRUCTURE;
